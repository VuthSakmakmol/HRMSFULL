...
const routes = [
  ...
  // 🌐 TA routes
  {
    ...
    children: [
      ...
      { path: 'performance', component: () => import('@/views/ta/TAPerformance.vue') },
...

  {
    ...
    children: [
...

      {
        ...
        component: () => import('@/views/hrss/ShiftAssignments.vue'),
...

      {
        ...
        name: 'ShiftTemplates',
        component: () => import('@/views/hrss/ShiftTemplates.vue'),
        meta: { requiresAuth: true },
      },
    ],
  },
